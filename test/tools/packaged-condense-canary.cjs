...
async function main() {
  ...
  try {
    ...
    // Prove it is the 1.1.57 artifact, not a stale build or the live install. The app
    ...
    check(start.version === '1.1.57', 'the artifact reports 1.1.57', `version=${start.version}`);
