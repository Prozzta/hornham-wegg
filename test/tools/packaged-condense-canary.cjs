...
async function main() {
  ...
  try {
    ...
    // Prove it is the 1.1.51 artifact, not a stale build or the live install. The app
    ...
    check(start.version === '1.1.51', 'the artifact reports 1.1.51', `version=${start.version}`);
